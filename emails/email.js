...
<table style="background-color:#283c53; font-family:'Montserrat',sans-serif; color:#fefefe">
  <tr>
    <td style="text-align:center;">
      <p style="font-size:36px;"><img src="https://image.ibb.co/hMyhun/qK34BJA.png" style="height:32px; width:32px;"/>Elevate</p>
    </td>
  </tr>

  <tr>
    <td style="padding:22px; line-height:1.8;">
      <p>${firstName},</p>
  ...
  <tr>
    <td style="text-align:center; padding:22px;">
      <a href="#" target="_blank">
        <img src="https://image.ibb.co/n6dFEn/Git_Hub_Mark_Light_120px_plus.png" style="height:32px; width:32px;"/>
        </a>
    </td>
  </tr>
</table>`
