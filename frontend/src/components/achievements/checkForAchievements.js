...
badge_id: 1 === 1 (First) job app logged
badge_id: 2 === 25 job app logs 
badge_id: 3 === 50 job app logs 
badge_id: 4 === 100 job app logs 
badge_id: 5 === 200 job app logs 
badge_id: 6 === 300 job app logs 
badge_id: 7 === 400 job app logs 
badge_id: 8 === 500 job app logs
badge_id: 9 === 1 (first interview) saved
badge_id: 10 === 5 interviews saved
badge_id: 11 === 15 interviews saved
  ...
  axios
    ...
    .then(res => {
      ...
      switch (jobs.length) {
        case 1:
      console.log(jobs.length)        
          addAchievement(1); // badge_id for 1st job app submitted
    ...
    .then(res => {
      ...
      switch (interviews.length) {
        ...
        console.log('First Interview Logged')
          addAchievement(9); // badge_id for 1st interview saved
          break;
...
//     axios.get('/users/getAllUserApps')
//     .then(data => {
